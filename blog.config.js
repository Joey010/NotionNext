...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    'a6037ff7383a4cd0afeff049273e94aa',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Joey', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '知行合一', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://wangpengju.netlify.app/', // 网站地址
